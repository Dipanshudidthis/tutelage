...
export const useSignup = () =>{
    ...
    const signup = async (fname, email, phoneNumber, collegeName, stream, year, password) => {
        setIsLoading(true);
        setError(null);
        ...
        const response = await fetch('/api/user/signup', {   //we are writing a fetch api here, this will get us the body 
            ...
            body: JSON.stringify({fname, email, phoneNumber, collegeName, stream, year, password})
        })
