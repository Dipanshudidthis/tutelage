...
function Add() {
    ...
    return (
        <>
            ...
            <Modal open={open}><Container className={classes.container}>
                <form className={classes.form} autoComplete='off'>
                    ...
                    <div className={classes.item}>
                        <TextField id="outlined-multiline-static"
                            ...
                            multiline
                            rows={4}
                            defaultValue="Tell your story..." size='small' style={{ width: '100%' }} />
                    </div>
                    {/* <div className={classes.item}>
            ...
            <Snackbar open={openAlert} autoHideDuration={4000} onClose={handleClose} anchorOrigin={{vertical: 'bottom',
          horizontal: 'left'}}>
